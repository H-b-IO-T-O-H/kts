    ...
    useEffect(() => {
        if (needDownload) {
            ...
            makeGet(url).then((response) => {
                ...
                errContent = "Ничего не найдено";
            });
            setInterval(() => {
                if (errContent !== "") {
                    showLabel({content: errContent, success: false});
                }
                setReady(false);
            }, 1000);
        }
